...
│   ├── config.py         # Конфигурация (версия 1.8.6)
...
### Последние обновления (версия 1.8.6)

- ✅ **Таймаут для архивов**: Добавлен 300-секундный таймаут для обработки архивов в соответствии с ТЗ
- ✅ **Полное извлечение из DOCX**: Добавлено извлечение колонтитулов, сносок и комментариев
- ✅ **Полное извлечение из PPTX**: Добавлено извлечение заметок спикера
- ✅ **Асинхронная обработка**: Все CPU-bound операции выполняются в отдельном пуле потоков
