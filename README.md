...
- 🌐 **Веб-экстракция**: Извлечение текста с веб-страниц с OCR изображений (новое в v1.10.0)
...
- **JavaScript**: Опциональная поддержка динамического контента
...
# Новые зависимости для веб-экстракции (v1.10.0):
# requests - HTTP клиент для загрузки страниц
# beautifulsoup4 - парсинг HTML
# lxml - быстрый XML/HTML парсер
# urllib3 - для проверки IP-адресов (защита от SSRF)
