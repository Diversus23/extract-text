...
* **Ответы с ошибкой:**
    ...
    * **`415 Unsupported Media Type`**: Формат файла не поддерживается или обнаружен архив.
...
* **Проверка MIME-типов:** Система проверяет соответствие содержимого файла заявленному расширению для предотвращения атак через подделку типа файла.
